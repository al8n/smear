  ...
  tokit::Token<'a, Error = TestErrors> + From<SyntacticToken<&'a str>> + Eq + Copy + core::fmt::Debug
{
  ...
  fn test_lexer(source: &'a str) -> TestLexer<'a, Self>
  where
    Self: Sized,
  {
...
impl<'a, T: TestToken<'a>> TestLexer<'a, T> {
  pub fn new(source: &'a str) -> Self {
    Self {
      inner: SyntacticLexer::new(source),
      _marker: PhantomData,
    }
  }

  pub fn span(&self) -> core::ops::Range<usize> {
    let span = Lexer::span(&self.inner);
    span.start()..span.end()
  }

  pub fn slice(&self) -> &'a str {
    Lexer::slice(&self.inner)
  }
}

pub(super) fn test_unexpected_character<'a, Token>()
where
  Token: TestToken<'a> + core::fmt::Debug,
{
...
pub(super) fn test_unknown_character<'a, Token>()
where
  Token: TestToken<'a> + core::fmt::Debug,
{
...
pub(super) fn test_number_leading_zero<'a, Token>()
where
  Token: TestToken<'a> + core::fmt::Debug,
{
...
pub(super) fn test_int_leading_zeros_then_check_suffix<'a, Token>()
where
  Token: TestToken<'a> + core::fmt::Debug,
{
  ...
  let err1 = errs[0]
    ...
    .unwrap_range_ref();
  assert_eq!(err1, &SimpleSpan::new(0, 2));
  let err2 = errs[1]
    .data()
    .unwrap_int_ref()
    .unwrap_unexpected_suffix_ref()
    .unwrap_range_ref();
  assert_eq!(err2, &SimpleSpan::new(2, 5));
  ...
  let err1 = errs[0]
    ...
    .unwrap_leading_zeros_ref()
    .unwrap_range_ref();
  assert_eq!(err1, &SimpleSpan::new(1, 3));
  let err2 = errs[1]
    .data()
    .unwrap_int_ref()
    .unwrap_unexpected_suffix_ref()
    .unwrap_range_ref();
  assert_eq!(err2, &SimpleSpan::new(3, 6));
}

pub(super) fn test_float_leading_zeros_and_other<'a, Token>()
where
  Token: TestToken<'a> + core::fmt::Debug,
{
  let mut lexer = Token::test_lexer("01.");
  ...
  assert_eq!(errs[1].span(), SimpleSpan::new(0, 3));
  ...
  let err2 = errs[1]
    ...
    .unwrap_unexpected_end_ref();
  assert_eq!(err2.hint(), &FloatHint::Fractional);
  assert_eq!(errs[1].span(), SimpleSpan::new(0, 4));
  ...
  let err1 = errs[0]
    ...
    .unwrap_leading_zeros_ref()
    .unwrap_range_ref();
  assert_eq!(err1, &SimpleSpan::new(0, 4));
  let err2 = errs[1]
    .data()
    .unwrap_float_ref()
    .unwrap_unexpected_suffix_ref()
    .unwrap_range_ref();
  assert_eq!(err2, &SimpleSpan::new(8, 12));
}

pub(super) fn test_invalid_number_suffix<'a, Token>()
where
  Token: TestToken<'a> + core::fmt::Debug,
{
  ...
  let err = lexer
    ...
    .unwrap_unexpected_suffix()
    .unwrap_range();
  assert_eq!(err, SimpleSpan::new(2, 5));
  ...
  let err = lexer
    ...
    .unwrap_unexpected_suffix()
    .unwrap_range();
  assert_eq!(err, SimpleSpan::new(3, 6));
  ...
  let err = lexer
    ...
    .unwrap_unexpected_suffix()
    .unwrap_range();
  assert_eq!(err, SimpleSpan::new(4, 7));
  ...
  let err = lexer
    ...
    .unwrap_unexpected_suffix()
    .unwrap_range();
  assert_eq!(err, SimpleSpan::new(4, 6));
  ...
  let err = lexer
    ...
    .unwrap_unexpected_suffix()
    .unwrap_range();
  assert_eq!(err, SimpleSpan::new(5, 7));
...
pub(super) fn test_missing_integer_part<'a, Token>()
where
  Token: TestToken<'a> + core::fmt::Debug,
{
...
pub(super) fn test_missing_integer_part_and_invalid_suffix<'a, Token>()
where
  Token: TestToken<'a> + core::fmt::Debug,
{
  ...
  let err2 = errs[1]
    ...
    .unwrap_unexpected_suffix_ref()
    .unwrap_range();
  assert_eq!(err2, SimpleSpan::new(4, 8));
  ...
  let err2 = errs[1]
    ...
    .unwrap_unexpected_suffix_ref()
    .unwrap_range();
  assert_eq!(err2, SimpleSpan::new(5, 9));
}

pub(super) fn test_unexpected_float_eof<'a, Token>()
where
  Token: TestToken<'a> + core::fmt::Debug,
{
  let mut lexer = Token::test_lexer("1.");
...
pub(super) fn test_unexpected_number_lexme<'a, Token>()
where
  Token: TestToken<'a> + core::fmt::Debug,
{
  ...
  let err = lexer
    ...
    .unwrap_unexpected_lexeme();
  assert_eq!(err.hint(), &FloatHint::Fractional);
  assert_eq!(err.lexeme().unwrap_range(), (2..5).into());
  assert_eq!(lexer.span(), (0..5));
  ...
  let err = lexer
    ...
    .unwrap_unexpected_lexeme();
  assert_eq!(err.hint(), &FloatHint::Fractional);
  assert_eq!(err.lexeme().unwrap_range(), (3..6).into());
  ...
  let err = lexer
    ...
    .unwrap_unexpected_lexeme();
  assert_eq!(err.hint(), &FloatHint::Fractional);
  assert_eq!(err.lexeme().unwrap_range(), (2..4).into());
  assert_eq!(lexer.span(), (0..4));
  ...
  let err = lexer
    ...
    .unwrap_unexpected_lexeme();
  assert_eq!(err.hint(), &FloatHint::Fractional);
  assert_eq!(err.lexeme().unwrap_range(), (3..5).into());
  assert_eq!(lexer.span(), (0..5));
  ...
  let err = lexer
    ...
    .unwrap_unexpected_lexeme();
  assert_eq!(err.hint(), &FloatHint::Exponent(ExponentHint::SignOrDigit));
  assert_eq!(err.lexeme().unwrap_range(), (4..12).into());
  ...
  let err = lexer
    ...
    .unwrap_unexpected_lexeme();
  assert_eq!(err.hint(), &FloatHint::Exponent(ExponentHint::SignOrDigit));
  assert_eq!(err.lexeme().unwrap_range(), (5..13).into());
  ...
  let err = lexer
    ...
    .unwrap_unexpected_lexeme();
  assert_eq!(err.hint(), &FloatHint::Exponent(ExponentHint::SignOrDigit));
  assert_eq!(err.lexeme().unwrap_range(), (2..10).into());
  ...
  let err = lexer
    ...
    .unwrap_unexpected_lexeme();
  assert_eq!(err.hint(), &FloatHint::Exponent(ExponentHint::SignOrDigit));
  assert_eq!(err.lexeme().unwrap_range(), (3..11).into());
...
pub(super) fn test_integer_ok<'a, Token>()
where
  Token: TestToken<'a> + core::fmt::Debug,
{
...
pub(super) fn test_float_ok<'a, Token>()
where
  Token: TestToken<'a> + core::fmt::Debug,
{
  let input: &[(&str, Token, usize)] = &[
...
pub(super) fn test_inline_string_ok<'a, Token>()
where
  Token: TestToken<'a> + core::fmt::Debug,
{
  let input: &[(&str, Token, usize)] = &[
...
pub(super) fn test_unterminated_inline_string<'a, Token>()
where
  Token: TestToken<'a> + core::fmt::Debug,
{
  ...
  assert_eq!(err1.span(), SimpleSpan::new(0, 13));
  ...
  assert_eq!(errs.len(), 1);
  let err = errs.pop().unwrap();
  assert_eq!(err.span(), SimpleSpan::new(0, 17));
  let err1 = err
    .into_data()
    .unwrap_string()
    .pop()
  ...
  assert_eq!(errs.len(), 1);
  let err = errs.pop().unwrap();
  assert_eq!(err.span(), SimpleSpan::new(0, 21));
  let err1 = err
    .into_data()
    .unwrap_string()
    .pop()
  ...
  match err1.hint() {
    ...
    LineTerminatorHint::CarriageReturnNewLine => {
      assert_eq!(err1.lexeme().unwrap_range(), SimpleSpan::new(9, 11));
    }
  }
  ...
  assert_eq!(errs.len(), 1);
  let err = errs.pop().unwrap();
  assert_eq!(err.span(), SimpleSpan::new(0, r#""hello✨"#.len()));
  let err1 = err
    .into_data()
    .unwrap_string()
    .pop()
...
pub(super) fn test_incomplete_unicode_and_eof<'a, Token>()
where
  Token: TestToken<'a> + core::fmt::Debug,
{
  ...
  assert_eq!(err.span(), SimpleSpan::new(0, 6));
  ...
  assert_eq!(err1.span(), SimpleSpan::new(1, 6));
  ...
  let err1 = err[0]
    ...
    .unwrap_fixed_ref()
    .unwrap_incomplete_ref();
  assert_eq!(err1.span(), SimpleSpan::new(1, 3));
...
pub(super) fn test_unexpected_line_terminator<'a, Token>()
where
  Token: TestToken<'a> + core::fmt::Debug,
{
  let mut lexer = Token::test_lexer(
...
""#,
  ...
  match err1.hint() {
    ...
    LineTerminatorHint::CarriageReturnNewLine => {
      assert_eq!(err1.lexeme().unwrap_range(), SimpleSpan::new(1, 3));
    }
  }
  ...
  match err2.hint() {
    ...
    LineTerminatorHint::CarriageReturnNewLine => {
      assert_eq!(err2.lexeme().unwrap_range(), SimpleSpan::new(7, 9));
    }
  }
  assert_eq!(lexer.span(), 0..9);
}

pub(super) fn test_unexpected_escaped<'a, Token>()
where
  Token: TestToken<'a> + core::fmt::Debug,
{
...
pub(super) fn test_surrogate_pair<'a, Token>()
where
  Token: TestToken<'a> + core::fmt::Debug,
{
  const CASES: &[&str] = &[
...
pub(super) fn test_invalid_surrogate_pair<'a, Token>()
where
  Token: TestToken<'a> + core::fmt::Debug,
{
  ...
  assert_eq!(err.span(), SimpleSpan::new(16, 22));
  ...
  assert_eq!(err.span(), SimpleSpan::new(22, 28));
  ...
  let err = err1
    ...
    .unwrap_unpaired_surrogate_ref();
  assert_eq!(err.hint(), &UnpairedSurrogateHint::High);
  assert_eq!(err.span(), SimpleSpan::new(12, 18));
  ...
  let err = err2
    ...
    .unwrap_unpaired_surrogate_ref();
  assert_eq!(err.hint(), &UnpairedSurrogateHint::Low);
  assert_eq!(err.span(), SimpleSpan::new(19, 25));
  ...
  let err = errs[0]
    ...
    .unwrap_unpaired_surrogate_ref();
  assert_eq!(err.hint(), &UnpairedSurrogateHint::High);
  assert_eq!(err.span(), SimpleSpan::new(21, 27));
...
pub(super) fn test_unterminated_block_string<'a, Token>()
where
  Token: TestToken<'a> + core::fmt::Debug,
{
  let mut lexer = Token::test_lexer(r#"""""#);
  ...
  assert_eq!(errs.len(), 1);
  let err = errs.pop().unwrap();
  assert_eq!(err.span(), SimpleSpan::new(0, 4));
  let err1 = err
    .into_data()
    .unwrap_string()
    .pop()
...
pub(super) fn test_surrogate_pair_in_block_string<'a, Token>()
where
  Token: TestToken<'a> + core::fmt::Debug,
{
  let mut lexer =
...
pub(super) fn test_escape_triple_quote_block_string<'a, Token>()
where
  Token: TestToken<'a> + core::fmt::Debug,
{
  let mut lexer = Token::test_lexer(
