...
pub type SelectionSet<Alias, Name, FragmentName, TypeCondition, Arguments, Directives> =
  lang::SelectionSet<Selection<Alias, Name, FragmentName, TypeCondition, Arguments, Directives>>;
  ...
  Directives: Parseable<'a, I, T, Error>,
{
  ...
  {
    recursive(|selection| {
      let selsetion_set = lang::SelectionSet::<Self>::parser_with(selection.clone());
