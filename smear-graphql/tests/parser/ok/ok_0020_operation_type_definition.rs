...
fn operation_type_definition() {
...

  {
    ...
    assert_eq!(cat.name().span().source(), &"cat");
    assert_eq!(cat.alias().unwrap().name().span().source(), &"animal");
...

  {
    ...
    assert_eq!(dog.name().span().source(), &"dog");
...

    {
      ...
      assert_eq!(panda.name().span().source(), &"panda");
...

      {
        ...
        assert_eq!(another_cat.name().span().source(), &"anotherCat");
...

  {
    ...
    assert_eq!(lion.name().span().source(), &"lion");
