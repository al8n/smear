...
#[derive(Debug, Clone)]
pub struct InputFieldsDefinition<InputValueDef, S, TriviaContainer = Vec<crate::cst::Trivia<S>>, Container = Vec<InputValueDef>> {
  span: Span,
  ...
  InputFieldsDefinition<InputValueDef, S, TriviaContainer, Container>
{
  ...
  pub const fn input_value_definitions(&self) -> &Container { &self.fields }
  ...
  for InputFieldsDefinition<InputValueDef, S, TriviaContainer, Container>
{
  ...
  fn into_components(self) -> Self::Components {
    (self.span, self.lbrace_padding, self.fields, self.rbrace_padding)
  }
}
