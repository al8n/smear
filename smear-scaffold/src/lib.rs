...
//!
//! ```rust,ignore
//! use smear_scaffold::{self, Parseable};
//!
...
//!   Standard(smear_scaffold::TypeDefinition</* ... */>),
...
//!     choice((
//!       TypeDefinition::parser().map(MyDefinition::Standard),
...
//! pub type MyDocument = smear_scaffold::Document<MyDefinition>;
//! ```
//!
//! # GraphQLX Example
//!
