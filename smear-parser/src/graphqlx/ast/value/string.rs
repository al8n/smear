  ...
  Lang: ?Sized,
{
  ...
  match token {
    ...
    tok => Err(Error::unexpected_token(tok, Expectation::StringValue, span).into()),
  }
}
  ...
  Lang: ?Sized,
{
  ...
  match token {
    ...
    tok => Err(Error::unexpected_token(tok, Expectation::InlineString, span).into()),
  }
}
  ...
  Lang: ?Sized,
{
  ...
  match token {
    ...
    tok => Err(Error::unexpected_token(tok, Expectation::BlockString, span).into()),
  }
}
