...
/// write. A `Span` sits in a leaf position on every value carrier, so it answers the same
/// question the source representation does (`al8n/smear#176`).
impl super::Leaf for CustomSpan {}
