  ...
  SchemaExtension<Directives, RootOperationTypesDefinition, Lang>
{
    ...
    RP: Parser<'src, I, RootOperationTypesDefinition, E> + Clone + 'src,
  {
    directives_parser
      ...
      .try_map_with(|(directives, root_operation_types_definition), _exa| {
        let content = match (directives, root_operation_types_definition) {
          ...
          (None, None) => {
            ...
            unreachable!("Schema extension requires either directives or root operation types definition");
          }
        };
