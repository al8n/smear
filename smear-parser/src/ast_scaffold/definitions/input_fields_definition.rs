...
pub struct InputFieldsDefinition<InputValueDefinition, Container = Vec<InputValueDefinition>, Lang = ()> {
  span: Span,
  values: Container,
...
impl<InputValueDefinition, Container, Lang> AsSpan<Span>
  for InputFieldsDefinition<InputValueDefinition, Container, Lang>
{
  #[inline]
...
impl<InputValueDefinition, Container, Lang> InputFieldsDefinition<InputValueDefinition, Container, Lang> {
