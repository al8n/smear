...
use super::{ParseStr, SyntacticTokenErrors, run_parse_str, default::*, fragment::*, type_system::*, combinators::*};
...
impl_parse_str!(DescribedObjectTypeDefinition<&'a str>, parse_described_object_type_definition);
impl_parse_str!(DescribedInterfaceTypeDefinition<&'a str>, parse_described_interface_type_definition);
impl_parse_str!(DescribedEnumTypeDefinition<&'a str>, parse_described_enum_type_definition);
impl_parse_str!(DescribedInputObjectTypeDefinition<&'a str>, parse_described_input_object_type_definition);
impl_parse_str!(ObjectTypeExtension<&'a str>, parse_object_type_extension);
impl_parse_str!(InterfaceTypeExtension<&'a str>, parse_interface_type_extension);
impl_parse_str!(EnumTypeExtension<&'a str>, parse_enum_type_extension);
impl_parse_str!(InputObjectTypeExtension<&'a str>, parse_input_object_type_extension);
