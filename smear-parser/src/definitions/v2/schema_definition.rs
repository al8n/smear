...
use crate::lang::keywords2::{Schema, Extend};
  ...
  SchemaDefinition<Directives, RootOperationTypesDefinition>
{
  ...
  #[inline]
  pub const fn schema_keyword(&self) -> &Schema {
    &self.schema
  }
    ...
    RP: Parser<'src, I, RootOperationTypesDefinition, E> + Clone,
  {
    Schema::parser()
      ...
      .map_with(
        |((schema, directives), operation_type_definitions), exa| Self {
          span: exa.span(),
          schema,
          directives,
  ...
  SchemaExtension<Directives, RootOperationTypesDefinition>
{
    ...
    RP: Parser<'src, I, RootOperationTypesDefinition, E> + Clone,
  {
    Extend::parser()
      ...
      .map_with(|((extend_keyword, schema_keyword), content), exa| Self {
        span: exa.span(),
