...
impl<'a, Variable, Type, DefaultValue, Directives, I, T, Error>
  Parseable<'a, I, T, Error> for VariableDefinition<Variable, Type, DefaultValue, Directives>
where
  T: Token<'a>,
  ...
  Colon: Parseable<'a, I, T, Error>,
{
    ...
    E: ParserExtra<'a, I, Error = Error> + 'a,
  {
    Variable::parser()
      ...
      .map_with(
        |((((variable, colon), ty), default_value), directives), exa| Self {
          span: exa.span(),
          variable,
          colon,
          ty,
...
impl<VariableDefinition, Container> VariablesDefinition<VariableDefinition, Container> {
    ...
    P: Parser<'src, I, VariableDefinition, E> + Clone,
  {
    LParen::parser()
      ...
      .then(RParen::parser())
      .map_with(|((l_paren, variables), r_paren), exa| Self {
        span: exa.span(),
        l_paren,
        r_paren,
        variables,
...
impl<'a, VariableDefinition, Container, I, T, Error>
  Parseable<'a, I, T, Error> for VariablesDefinition<VariableDefinition, Container>
where
  T: Token<'a>,
  I: Tokenizer<'a, T, Slice = <T::Source as Source>::Slice<'a>>,
  Error: 'a,
