...
fn bench_cynic_parser_parse_gitlab_schema(c: &mut Criterion) {
  c.bench_function(
    "cynic-parser: tests/fixtures/schemas/gitlab_schema.graphql",
...
criterion_group!(
  ...
  bench_cynic_parser_parse_gitlab_schema,
);
