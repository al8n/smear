...
fn bench_apollo_parser_parse_github_schema(c: &mut Criterion) {
  c.bench_function(
    "apollo-parser: tests/fixtures/schemas/github_schema.graphql",
...
fn bench_smear_parser_parse_github_schema(c: &mut Criterion) {
  c.bench_function(
    "smear: tests/fixtures/schemas/github_schema.graphql",
...
fn bench_graphql_parser_parse_github_schema(c: &mut Criterion) {
  c.bench_function(
    "graphql-parser: tests/fixtures/schemas/github_schema.graphql",
...
fn bench_async_graphql_parser_parse_github_schema(c: &mut Criterion) {
  c.bench_function(
    "async-graphql-parser: tests/fixtures/schemas/github_schema.graphql",
