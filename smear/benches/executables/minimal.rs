...
fn bench_apollo_parser_minimal(c: &mut Criterion) {
  c.bench_function(
    "apollo-parser: tests/fixtures/executables/minimal.graphql",
...
fn bench_smear_parser_minimal(c: &mut Criterion) {
  c.bench_function(
    "smear: tests/fixtures/executables/minimal.graphql",
...
fn bench_graphql_parser_minimal(c: &mut Criterion) {
  c.bench_function(
    "graphql-parser: tests/fixtures/executables/minimal.graphql",
...
fn bench_async_graphql_parser_minimal(c: &mut Criterion) {
  c.bench_function(
    "async-graphql-parser: tests/fixtures/executables/minimal.graphql",
...
fn bench_cynic_parser_minimal(c: &mut Criterion) {
  c.bench_function(
    "cynic-parser: tests/fixtures/executables/minimal.graphql",
