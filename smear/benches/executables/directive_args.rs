...
const QUERY: &str = include_str!("../../tests/fixtures/executables/directive_args.graphql");

fn bench_apollo_parser_directive_args(c: &mut Criterion) {
  c.bench_function(
    "apollo-parser: tests/fixtures/executables/directive_args.graphql",
...
fn bench_smear_parser_directive_args(c: &mut Criterion) {
  c.bench_function(
    "smear: tests/fixtures/executables/directive_args.graphql",
...
fn bench_graphql_parser_directive_args(c: &mut Criterion) {
  c.bench_function(
    "graphql-parser: tests/fixtures/executables/directive_args.graphql",
...
fn bench_async_graphql_parser_directive_args(c: &mut Criterion) {
  c.bench_function(
    "async-graphql-parser: tests/fixtures/executables/directive_args.graphql",
...
fn bench_cynic_parser_directive_args(c: &mut Criterion) {
  c.bench_function(
    "cynic-parser: tests/fixtures/executables/directive_args.graphql",
