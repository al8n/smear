...
fn bench_apollo_parser_kitchen_sink(c: &mut Criterion) {
  c.bench_function(
    "apollo-parser: tests/fixtures/executables/kitchen-sink.graphql",
...
fn bench_smear_parser_kitchen_sink(c: &mut Criterion) {
  c.bench_function(
    "smear: tests/fixtures/executables/kitchen-sink.graphql",
...
fn bench_graphql_parser_kitchen_sink(c: &mut Criterion) {
  c.bench_function(
    "graphql-parser: tests/fixtures/executables/kitchen-sink.graphql",
...
fn bench_cynic_parser_kitchen_sink(c: &mut Criterion) {
  c.bench_function(
    "cynic-parser: tests/fixtures/executables/kitchen-sink.graphql",
