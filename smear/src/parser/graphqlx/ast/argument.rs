...
pub type ConstArguments<S, Span = SimpleSpan, Container = DefaultVec<ConstArgument<S, Span>>> =
  crate::argument::ArgumentList<ConstArgument<S, Span>, Container, Span>;
