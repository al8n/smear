...
pub type ArgumentsDefinition<S, Ty = Type<Name<S>>> =
  crate::parser::type_system::ArgumentsDefinition<InputValueDefinition<S, Ty>>;
...
pub type InputFieldsDefinition<S, Ty = Type<Name<S>>> =
  crate::parser::type_system::InputFieldsDefinition<InputValueDefinition<S, Ty>>;
...
pub type FieldsDefinition<S, Ty = Type<Name<S>>> =
  crate::parser::type_system::FieldsDefinition<FieldDefinition<S, Ty>>;

/// Scalar type definition (`scalar Name Directives?`).
pub type ScalarTypeDefinition<S> =
  crate::parser::type_system::ScalarTypeDefinition<Name<S>, ConstDirectives<S>>;
...
pub type ObjectTypeDefinition<S, Ty = Type<Name<S>>> =
...
pub type UnionTypeDefinition<S> = crate::parser::type_system::UnionTypeDefinition<
  Name<S>,
  ConstDirectives<S>,
...
pub type EnumValueDefinition<S> =
  Described<crate::parser::type_system::EnumValueDefinition<Name<S>, ConstDirectives<S>>, S>;

/// List of enum value definitions (`{ EnumValueDefinition+ }`).
pub type EnumValuesDefinition<S> =
  crate::parser::type_system::EnumValuesDefinition<EnumValueDefinition<S>>;

/// Enum type definition (`enum Name Directives? EnumValuesDefinition?`).
pub type EnumTypeDefinition<S> = crate::parser::type_system::EnumTypeDefinition<
  Name<S>,
  ConstDirectives<S>,
...
pub type ScalarTypeExtension<S> =
  crate::parser::type_system::ScalarTypeExtension<Name<S>, ConstDirectives<S>>;

/// Object type extension (`extend type Name` plus a nonempty extension payload).
pub type ObjectTypeExtension<S, Ty = Type<Name<S>>> =
...
pub type InterfaceTypeExtension<S, Ty = Type<Name<S>>> =
...
pub type UnionTypeExtension<S> = crate::parser::type_system::UnionTypeExtension<
  Name<S>,
  ConstDirectives<S>,
  UnionMemberTypes<Name<S>>,
>;
...
pub type EnumTypeExtension<S> = crate::parser::type_system::EnumTypeExtension<
  Name<S>,
  ConstDirectives<S>,
  EnumValuesDefinition<S>,
>;
...
pub type RootOperationTypeDefinition<S> =
  crate::parser::type_system::RootOperationTypeDefinition<Name<S>, OperationType>;

/// List of root operation type definitions for a schema
/// (`{ RootOperationTypeDefinition+ }`).
pub type RootOperationTypesDefinition<S> =
  crate::parser::type_system::RootOperationTypesDefinition<RootOperationTypeDefinition<S>>;

/// Schema definition (`schema Directives? RootOperationTypesDefinition`).
pub type SchemaDefinition<S> =
  crate::parser::type_system::SchemaDefinition<ConstDirectives<S>, RootOperationTypesDefinition<S>>;
...
pub type TypeExtension<S, Ty = Type<Name<S>>> = crate::parser::type_system::TypeExtension<
...
pub type SchemaExtension<S> =
  crate::parser::type_system::SchemaExtension<ConstDirectives<S>, RootOperationTypesDefinition<S>>;

/// Type-system definition: a named type, directive, or schema definition.
pub type TypeSystemDefinition<S, Ty = Type<Name<S>>> =
...
pub type TypeSystemExtension<S, Ty = Type<Name<S>>> =
  crate::parser::type_system::TypeSystemExtension<TypeExtension<S, Ty>, SchemaExtension<S>>;
...
pub type TypeSystemDocument<S, Ty = Type<Name<S>>> =
  crate::parser::executable::Document<TypeSystemDefinitionOrExtension<S, Ty>>;

/// A GraphQL definition: either a type-system or executable definition.
pub type Definition<S, Ty = Type<Name<S>>> =
  crate::parser::executable::Definition<TypeSystemDefinition<S, Ty>, ExecutableDefinition<S, Ty>>;
