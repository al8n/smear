...
fn bench_apollo_parser_parse_supergraph(c: &mut Criterion) {
  c.bench_function(
    "apollo-parser: tests/fixtures/schemas/supergraph.graphql",
...
fn bench_smear_parser_parse_supergraph(c: &mut Criterion) {
  c.bench_function(
    "smear: tests/fixtures/schemas/supergraph.graphql",
...
fn bench_graphql_parser_parse_supergraph(c: &mut Criterion) {
  c.bench_function(
    "graphql-parser: tests/fixtures/schemas/supergraph.graphql",
...
fn bench_async_graphql_parser_parse_supergraph(c: &mut Criterion) {
  c.bench_function(
    "async-graphql-parser: tests/fixtures/schemas/supergraph.graphql",
...
fn bench_cynic_parser_parse_supergraph(c: &mut Criterion) {
  c.bench_function(
    "cynic-parser: tests/fixtures/schemas/supergraph.graphql",
